...
import cn.milai.ib.demo.character.plane.FollowPlane;
...
public class EndlessBattleMode extends AbstractGameMode implements ContainerEventListener {
	...
	private static final String DRAMA_CODE = "cn.milai.ib.demo.mode.EndlessBattleMode";
